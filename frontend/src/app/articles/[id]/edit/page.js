...
import { BookOpen, ArrowLeft, Save, Eye, EyeOff, History } from 'lucide-react'
...
export default function EditArticlePage({ params }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await updateArticle(params.id, formData)
  ...
  // Show loading state while checking authentication or loading article
  ...
  // Don't render form if not authenticated or article not loaded
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <Link href={`/articles/${params.id}/history`}>
